...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[TableViewCell3 class] forCellReuseIdentifier:@"pictureCell"];
...
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row == 0) {
            cell1.detailTextLabel.text = @"279";
            return cell1;
        }
        if (indexPath.row == 1) {
            cell1.detailTextLabel.text = @"101";
            return cell1;
        }
        if (indexPath.row == 2) {
        ...
        if (indexPath.row == 3) {
            cell1.detailTextLabel.text = @"专辑/歌手/视频/专栏";
            return cell1;
        }
        return cell1;
    }
    ...
    if (indexPath.section == 1) {
        TableViewCell3 *cell2 = [tableView dequeueReusableCellWithIdentifier:@"pictureCell" forIndexPath:indexPath];
        ...
        TableViewCell3 *cell3 = [tableView dequeueReusableCellWithIdentifier:@"pictureCell" forIndexPath:indexPath];
